  ...
  return (
    <div>
      ...
      <p>
        ...
        of the Cookies Policy Generator.
      </p>
      <p>
      ...
      <ul>
        <li>
          ...
          "Us" or "Our" in this Cookies Policy) refers to Whitelister.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong>refers to Whitelister, accessible from
          http://www.white-lister.com/
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <strong>Functionality Cookies Type:</strong>
          Persistent Cookies Administered by: Us Purpose: These Cookies allow us
      ...
      <h1>More Information about Cookies
</h1>
<p>You can learn more about cookies here: All About Cookies by TermsFeed.
...
<ul>
    <li>By email: whitelister.team@gmail.com</li>
    <li>By visiting this page on our website: http://www.white-lister.com/</li>
</ul>
    </div>
  );
};
